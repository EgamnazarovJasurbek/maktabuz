            ...
            <div class="headerBar">
                <div class="topMainMenu">
                    <a href="{{ route('index') }}" class="topMain-logo">
                        <img src="assets/image/Gerb.png" alt="" width="8%">
                            ...
                            <div class="overlay">
                                <div class="container">
                                    <div class="topLogoGerb">
                                        <img src="assets/image/Gerb.png" alt="Logo" width="13%">
                                    </div>
                                    <div class="listMenu">
                                        <ul>
                ...
                <div class="footer">
                    <div class="container">
                        ...
                        <div class="footer_logo">
                            <span>
                                <img src="assets/image/Gerb.png" alt="Logo" width="20%">
                            </span>
                            <a href="">
                        ...
                        <a href="#" class="it_live-logo">
                            <img src="assets/image/It live logo for red-04-04.png" alt="IT_Live"
                                class="it_live-img">
                        </a>
